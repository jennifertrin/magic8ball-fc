...
export interface Magic8BallNFTInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "approve"
      | "balanceOf"
...
export interface Magic8BallNFT extends BaseContract {
  connect(runner?: ContractRunner | null): Magic8BallNFT;
  waitForDeployment(): Promise<this>;

  interface: Magic8BallNFTInterface;
  ...
  filters: {
    ...
    "MintingFeeChanged(uint256,uint256)": TypedContractEvent<
      MintingFeeChangedEvent.InputTuple,
      MintingFeeChangedEvent.OutputTuple,
      MintingFeeChangedEvent.OutputObject
    >;
